      ...
      <Container fluid>
        <Row className="mt-sm-5 mt-3 ms-sm-5">
            ...
            <Col className="col-sm-6 col-12 ">
              <div className='text-sm-end text-center justify-content-end ms-sm-5 py-4 py-sm-0'>
        ...
        <Card className="my-sm-4 my-3 mx-sm-2 border-0 artikel__home rounded-3 " id="layanan">
            <Row>
                ...
                <Col className="col-md-10 col-12">
                    ...
                    <Card.Text className="artikel-text m-3 mr-sm-5 m-sm-0 text-justify pb-2 "> {layanan.description}</Card.Text>
                  <div className='mt-5 mt-sm-5'>
                    <Link to="/layanan" className='artikel__selengkapnya mt-sm-5 ms-3 ms-sm-0'>Selengkapnya</Link>
